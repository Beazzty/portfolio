...
export default function viteSvg(options = {}) {
    const _default = (options === null || options === void 0 ? void 0 : options.default) || 'json';
    return {
